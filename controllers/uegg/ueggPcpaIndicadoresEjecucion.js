...
module.exports = {                                                                                                                                                                                                                                                                                                                                                                                                                             
    ...
    add(req, res) {
        return UeggPcpaIndicadoresEjecucion.create({
            ...
            id_pcpa_indicador_ejecucion: req.body.id_pcpa_indicador_ejecucion,
          ...
          .then(ueggPcpaIndicadoresEjecucion => {
            ...
            return ueggPcpaIndicadoresEjecucion
              .update({
                ...
                id_pcpa_indicador_ejecucion: req.body.id_pcpa_indicador_ejecucion  || ueggPcpaIndicadoresEjecucion.id_pcpa_indicador_ejecucion,
