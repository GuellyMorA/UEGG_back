...
module.exports = {
    ...
    getById(req, res) {
        ...
        return InfraInternetDisponibilidadTipo
            ...
            .then((infraInternetDisponibilidadTipo) => {//rbc
                ...
                return res.status(200).send(infraInternetDisponibilidadTipo); // rbc return res.status(200).send(InfraInternetDisponibilidadTipo);
            })
            .catch((error) => res.status(400).send(error));
    },
