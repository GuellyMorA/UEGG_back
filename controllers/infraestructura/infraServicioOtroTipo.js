...
module.exports = {
    ...
    async updateServicioOfreceCuenta(req, res) {
        ...
        if (siIntet[0].count != 0) {
            ...
            console.log(':-o', req.body); //   console.log(JSON.stringify(req.body)); rbc
        ...
        try {
            ...
            if (conexion.length > 0) {    // {attributes: ['id', 'conexion_tipo'] });
                ...
                console.log('*-*-*-*', conexion ); //rbc  'infra_predio_id': req.body.infra_predio_id,
                ...
                console.log('*-*-*-* nuevo insert.- ', ' infraInternetDisponibilidadServicioTipo'); //rbc
                ...
                for (const item of req.body.servicioInternet.perI) {     // servicioInternet rbc
