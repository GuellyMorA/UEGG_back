const InfraInternetConexionTipo = require('../../models/infraestructura').infra_internet_conexion_tipo; //rbc infraInternetConexionTipo;
...
module.exports = {
    ...
    getById(req, res) {
        ...
        return InfraInternetConexionTipo
            ...
            .then((infraInternetConexionTipo) => { // rbc
                ...
                return res.status(200).send(infraInternetConexionTipo); // rbc
            })
            .catch((error) => res.status(400).send(error));
    },
